...
<style>
      * {
      ...
      .main {
        ...
        width: 100%;
        height: 100%;
        background: url(../index/images/back.jpg) 100% 100% no-repeat;
      }
      /*让输入框居中*/
      .loginFrame {
        width: 700px;
